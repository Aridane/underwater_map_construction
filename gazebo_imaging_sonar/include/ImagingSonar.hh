...
#ifndef _IMAGINGSONARSENSOR_HH_
#define _IMAGINGSONARSENSOR_HH_
...
#include "sonar_scan_line_stamped.pb.h"
...
namespace gazebo
{
  ...
  namespace sensors
  {
    ...
    /// \class ImagingSonarSensor SonarSensor.hh sensors/sensors.hh
    /// \brief Sensor with sonar cone.
    ///
    /// This sensor uses a cone .
    class ImagingSonarSensor: public Sensor
    {
      /// \brief Constructor
      public: ImagingSonarSensor();

      /// \brief Destructor
      public: virtual ~ImagingSonarSensor();
      ...
      private: gazebo_imaging_sonar::msgs::SonarScanLineStamped scanLineMsg;
      ...
      /// \brief Update event.
      protected: event::EventT<void(gazebo_imaging_sonar::msgs::SonarScanLineStamped)> update;
    };
    /// \}
  }
}
